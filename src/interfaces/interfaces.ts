...
import { UserInfo } from '../pages/info-modify/info-modify';
import { UpdatePassword } from '../pages/password-modify/password-modify';
import { CreateMeetingRoom } from '../pages/meeting-room-manage/create-meeting-modal';
import { UpdateMeetingRoom } from '../pages/meeting-room-manage/update-meeting-room';
import { SearchBooking } from '../pages/booking-manage/booking-manage';
import dayjs from 'dayjs';

const axiosInstance = axios.create({
    baseURL: 'http://39.108.118.4:81/api',
    timeout: 3000
})
...
export async function meetingRoomUseCount(startTime: string, endTime: string) {
    return await axiosInstance.get('/statistic/meetingRoomUseCount', {
        params: {
            startTime,
            endTime
        }

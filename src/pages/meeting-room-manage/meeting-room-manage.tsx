import { Button, Form, Input,Badge,Table, message, Popconfirm } from "antd";
...
import { CreateMeetingRoomModal } from "./create-meeting-modal";
import { UpdateMeetingRoomModal } from "./update-meeting-room";
...
export function MeetingRoomManage() {
    ...
    const columns: ColumnsType<MeetingRoomSearchResult> = useMemo(() => [
        ...
        },
        {
            title: '预定状态',
            dataIndex: 'isBooked',
            render: (_: any, record: { isBooked: any; }) => (
